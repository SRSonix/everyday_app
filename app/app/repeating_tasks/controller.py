...
from app.repeating_tasks.schemas import RepeatingTaskCreateRequest, RepeatingTaskResponse
...
def create_repeating_task(
    ...
    task = service.add_task(name=request.name, repeats_every_days=request.repeats_every_days)
