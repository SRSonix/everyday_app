...
* we use entities (business logic models) and schemas (API request / response models). entities are stored in the service folder and the schemas in the controller folder. schemas have a from_entity or to_entity method if needed.
